...
<img src="images/tipsheets/benefits_breakfast.jpg" width=172 height=245 border=0 alt="" align="right" style="padding-left:20px; padding-top:3px; padding-bottom:16px;">
Starting your day without breakfast is sort of like driving on a nearly empty tank. You might be able to coast for a little while, but soon your energy will run out. A healthy breakfast can help keep you going all day, help you control your weight, and more. Check out these tips for some ideas.<br><br>

&nbsp;
<ul>
<li><a href="health_tips-breakfast1.php">Best Reasons to Eat Breakfast</a></li>
<li><a href="health_tips-breakfast2.php">Breakfast Foods to Choose</a></li>
<li><a href="health_tips-breakfast3.php">Beat-the-Clock Breakfasts</a></li>
</ul><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <img src="images/rightnav-header_nutrition-R.gif" width=170 height=33 border=0 alt="" vspace=2>
        <div style="margin-left:12px; margin-top:0px; margin-right:12px; margin-bottom:5px;" class="tipsSubText">
        <ul class="UL1">
        <li><b>The Benefits of Breakfast</b>
            <ul class="UL2">
            <li><a href="health_tips-breakfast1.php" class="tipsSubLink">Best Reasons to Eat Breakfast</a></li>
