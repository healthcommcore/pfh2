...
<span class="tipsHeader">DURING THE DAY</span><br>

<ul>
<li>Try not to drink anything with caffeine, like coffee, tea, or dark cola. If you can't cut out caffeine completely, try to drink less. Don't drink it at all after lunchtime.</li>
<li>Get some <a href="health_tips-activity.php">exercise</a>, which helps you sleep better. But avoid exercising within three hours of bedtime. </li>
<li>Use your bed only for sleeping and sex, not for watching TV, talking on the phone, or eating.</li>
<li>Set a bedtime for weeknights. Try to keep to the same time each night.</li>
</ul>
