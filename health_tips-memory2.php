...
<span class="tipsHeader">GETTING ORGANIZED</span><br>
<ul>
<li>Think about the things you forget most, and make a routine to follow. For example, do you always forget to grab your lunch before leaving the house? Try putting your coat on first, getting your lunch second, and grabbing your keys last.</li>
<li>Give yourself cues that help keep you organized. If you run out of dog food, put the empty dog food bag by the door to remind you to buy more. Cues can also involve sounds and words. Leave yourself reminder messages on your voice mail. Set a timer to ring when food is going to be done cooking.</li>
<li>Use a PDA or day planner. Type in or write down important things immediately, and remember to look at it. You can help yourself remember to check a PDA by setting an alarm to go off at different times. If you have a day planner, look at it at the same time each day.</li>
</ul>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><a href="health_tips-memory.php" class="tipsSubLink"><b>Memory</b></a>
            ...
            <li><b>Getting Organized</b></li>
            <li><a href="health_tips-memory3.php" class="tipsSubLink">Medications and Nutritional Supplements</a></li>
            </ul></li>
        </ul></div>
