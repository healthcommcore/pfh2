...
<span class="manualHeader">WHY THINK MORE SERIOUSLY ABOUT QUITTING?</span><br><br>
<?
if ($HTTP_POST_VARS["submitAction"]=="saveEntry") {
    ...
    $mysqlID=dbConnect();
    $resultID=mysql_query("UPDATE PFHUserInfo SET quittingMeans2CHECKS=\"".$quittingMeansCHECKS."\", quittingMeans2NOTES=\"".addslashes($quittingMeansNOTES)."\" WHERE id=".$_SESSION["userID"],$mysqlID);
    dbClose();
    echo "<b>Thank you. Your changes have been saved.</b><br><br>\n\n";
}
?>
If you enjoy smoking, it might be hard to imagine all the day-to-day benefits of quitting. Even though you may not be ready to quit right now, take a look at this list of benefits. It may give you something to think about.<br><br>
...
<PARAM NAME=movie VALUE="images/flash/list9b.swf">
<PARAM NAME=quality VALUE=high>
<PARAM NAME=bgcolor VALUE=#FBFAE9>
<EMBED width=341 height=635 bgcolor="#FBFAE9" name="myList" src="images/flash/list9b.swf" quality=high TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" swLiveConnect="true"></EMBED>
</OBJECT><br><br>
