...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/tips_exercise.gif" width=400 height=99 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

Exercise is a great way to help your body and mind &#150;  it helps you get fit, boosts your mood, and can help you manage your <a href="health_tips-weight.php">weight</a>.  It can also be a very useful part of quitting smoking &#150;  not only can it lift your spirits, it can distract you from urges to smoke. <br><br>

<img src="images/tipsheets/exercise.jpg" width=180 height=97 border=0 alt="" align="right" style="padding-left:20px; padding-top:3px;  padding-bottom:16px;">
The benefits of exercise go on and on: more energy, stronger heart and lungs, less <a href="health_tips-stress.php">stress</a>, and better resistance to illness. Being active can also give you a sense of pride and more self-esteem &#150;  you'll look good and feel good! Keep reading for more information about the benefits of exercise and easy ways to get more of it.<br>

<ul>
<li><a href="health_tips-activity1.php">Physical and Mental Pluses of Exercise</a></li>
<li><a href="health_tips-activity2.php">How to Get More Exercise</a></li>
</ul>

<b>Remember:</b><br>
<ul>
<li>It's important to stop exercising before you feel tired.</li>
<li>Warm up before exercising, and cool down and stretch out afterwards. This will help prevent injury.</li>
</ul><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><b>Exercise</b>
            <ul class="UL2">
            <li><a href="health_tips-activity1.php" class="tipsSubLink">Physical and Mental Pluses of Exercise</a></li>
            <li><a href="health_tips-activity2.php" class="tipsSubLink">How to Get More Exercise</a></li>
            </ul></li>
