...
You probably smoke for the same reason as anyone else: you're addicted to the nicotine in cigarettes. Overcoming addiction can be difficult, but it's not impossible  &#150;  and it's easier with the therapies available now. If you decide to quit smoking, <i>Partnership for Health</i> can give you free nicotine patches or Zyban. Zyban is a prescription medication that contains Wellbutrin, an antdepressant. It has been found to lower nicotine cravings. Unlike the patch, you can take it while you're still smoking, but it's not recommended for pregnant women or people who are at a higher risk for seizures.<br><br>
