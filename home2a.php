...
<tr>
    ...
    <img src="images/allAboutYou.jpg" width=155 height=137 border=0 alt=""><br>
        ...
        <tr>
            ...
            When you took the Partnership for Health survey, 
            your answers suggested that you may be addicted to the nicotine in cigarettes. 
            If you ever decide to give quitting a try, there are great ways to deal with cravings, 
            and they're all available at no cost from Partnership for Health. <a href="" class="column1Link">Read more&#133;</a><br><br>
            &nbsp;</td>
...
<img src="images/counselor.gif" width=180 height=334 border=0 alt="" align="right" style="padding-left:20px; padding-top:3px;  padding-bottom:16px;">
            ...
            and that as smokers, they are more likely to get cancers that aren't as treatable as the ones they had as children.<br><br>
    ...
    <PARAM NAME=movie VALUE="images/ads/ad_cost.swf">
    <PARAM NAME=quality VALUE="high">
    <EMBED src="images/ads/ad_cost.swf" quality=high WIDTH="170" HEIGHT="165" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED>
