...
//mb
//
	'L_POST_SUBJECT_TOPIC' => $lang['Post_subject_topic'],
	'L_POST_REPLY_SUBJECT' => $lang['Post_reply_subject'],
//mb change subject name for replys
//	'L_POST_SUBJECT' => $lang['Post_reply_subject'],	//not used
...
//reversed newer and older
	'U_VIEW_OLDER_TOPIC' => $view_next_topic_url,
	'U_VIEW_NEWER_TOPIC' => $view_prev_topic_url,
...
//mb make username id 4 or 8 font color red	

	$poster = ( $poster_id == 4 ) ? $lang['modfont1'] : $postrow[$i]['<font color="#c82c37">'];
	
	$poster .= ( $poster_id == ANONYMOUS ) ? $lang['Guest'] : $postrow[$i]['username'];

	$poster .= ( $poster_id == 4 ) ? $lang['modfont3'] : $postrow[$i]['</font>'];
...
//mb 520 report post to modr BEGIN
	if ( $i == 0 && !isset($rp) )
	{
...
// Ê Ê if ( $userdata['user_level'] == ADMIN && $userdata['session_logged_in'] ) 
//Ê Êif ( $is_auth['auth_mod'] ) 
...
//mb removed link to unalert admin

		$report_img = '<img src="' . $images['icon_del_report'] . '" alt="' . $lang['Report_del'] . '" title="' . $lang['Report_del'] . '" border="0" />';
		$report = 'a' . $temp_url . '">' . $lang['Report_del'] . 'z';
...
//mb 520 report post to modr END

//
//mb change subject title to new topic
	//$post_subject = ( $postrow[$i]['post_subject_topic'] != '' ) ? $postrow[$i]['post_subject_topic'] : '';
// top row subject text	
//	$post_subject = ( $postrow[$i]['post_subject'] != '' ) ? $postrow[$i]['post_subject'] : '';
	...
	$template->assign_block_vars('postrow', array(
		...
		'POST_DATE' => $post_date,
//mb reply subject is orig post topic tile
//		'POST_SUBJECT' => $post_subject,
		'POST_SUBJECT' => $topic_title,
//mb new topic
		'POST_SUBJECT_TOPIC' => $post_subject_topic,
		'POST_REPLY_SUBJECT' => $post_reply_subject,
