...
//mb always send user back to viewforum
		$template->assign_vars(array(
//			'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid("privmsg.$phpEx?folder=inbox") . '">')
			'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid("viewforum.php?f=1") . '">')

		);
//mb always send user back to viewforum not index.
//		$msg = $lang['Message_sent'] . '<br /><br />' . sprintf($lang['Click_return_inbox'], '<a href="' . append_sid("privmsg.$phpEx?folder=inbox") . '">', '</a> ') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid("index.$phpEx") . '">', '</a>');
		$msg = $lang['Message_sent'] . '<br /><br />' . sprintf($lang['Click_return_inbox'], '<a href="' . append_sid("privmsg.$phpEx?folder=inbox") . '">', '</a> ') . '<br /><br />' . sprintf($lang['Click_return_forum'], '<a href="' . append_sid("viewforum.php?f=1") . '">', '</a>');
...
//mb always return to forum
//		'U_VIEW_FORUM' => append_sid("privmsg.$phpEx"))
		'U_VIEW_FORUM' => append_sid("viewforum.php?f=1"))
	);
