...
<div align="left"><h1>{L_WELCOME}</h1></div>

<table width="90%" align="center" cellspacing="0" cellpadding="0">
<tr>
<td>
<div class="gen2">{L_ADMIN_INTRO}</div><br />
</td>
</tr>
</table>

<div align="left"><h1>cleanLegacy v1.2</h1></div>

<table width="90%" align="center" cellspacing="0" cellpadding="0">
<tr>
<td>
<div class="gen2">Hello and thank you for choosing to use one of my templates for your forum.<Br /><br />
If you haven't noticed yet I did a lot of custom work on this theme to make the look different than most forums. The most recognizable
change is in the posting display. I changed it to a less cluttered design in order to cut down on extras and provide more room for posting.<br /><br />

Support for this forum can be found at: <a href="http://www.untoldlegacy.com">www.untoldlegacy.com</a><br />
It was created by: <a href="http://www.untoldlegacy.com">Eric Bobbitt</a><br /><br />

Changes:<br />
-Custom Admin Panel
-Various tweaks
-Color formatting</div><br />
</td>
</tr>
</table>


<div align="left"><h1>{L_FORUM_STATS}</h1></div>
...
<div align="left"><h1>{L_WHO_IS_ONLINE}</h1></div>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr>
        <td colspan="5" height="1" class="row3"><img src="../templates/cleanLegacy/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
