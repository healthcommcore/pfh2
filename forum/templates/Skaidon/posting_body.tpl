...
var clientPC = nav2igator.userAgent.toLowerCase(); // Get client info
var clientVer = parseInt(nav2igator.appVersion); // Get browser version

var is_ie = ((clientPC.indexOf("msie") != -1) && (clientPC.indexOf("opera") == -1));
var is_nav2 = ((clientPC.indexOf('mozilla')!=-1) && (clientPC.indexOf('spoofer')==-1)
...
<table width="90%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
		<td align="left"><span  class="nav2"><a href="{U_INDEX}" class="nav2">{L_INDEX}</a>
		<!-- BEGIN switch_not_privmsg --> 
		-> <a href="{U_VIEW_FORUM}" class="nav2">{FORUM_NAME}</a></span></td>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
    ...
    <td class="row2" width="78%"> <span class="gen"> 
      <input type="text" name="subject" size="45" maxlength="60" style="width:250px" tabindex="2" class="post" value="{SUBJECT}" />
      </span> </td>
  </tr>
  <tr align="center"> 
    <td colspan="2" valign="top" class="row1"> <span class="gen"> <span class="genmed"> 
      </span> 
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr align="center"> 
          <td colspan="9"> <span class="gensmall"> 
            <input type="text" name="helpbox" size="45" maxlength="100" style="width:350px; font-size:10px" class="helpline" value="{L_STYLES_TIP}" />
            </span></td>
        </tr>
        <tr align="center"> 
          <td colspan="9"><span class="gen"> 
            <textarea name="message" rows="15" cols="35" wrap="virtual" style="width:350px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
            </span></td>
        </tr>
      </table>
      </span></td>
  ...
  <tr align="center"> 
    <td colspan="2" valign="top" class="row1"> <table width="100" border="0" cellspacing="0" cellpadding="5">
        <tr align="center"> 
        ...
        <tr align="center"> 
          <td colspan="{S_SMILIES_COLSPAN}"><span  class="nav2"><a href="{U_MORE_SMILIES}" onclick="window.open('{U_MORE_SMILIES}', '_phpbbsmilies', 'HEIGHT=300,resizable=yes,scrollbars=yes,WIDTH=250');return false;" target="_phpbbsmilies" class="nav2">{L_MORE_SMILIES}</a></span></td>
        </tr>
  ...
  <tr> 
    ...
    <td class="row2"><span class="gen"> </span> <table cellspacing="0" cellpadding="1" border="0">
