			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="templates/Skaidon/images/vote_lcap.gif" width="6" alt="" height="11" /></td>
					<td><img src="{poll_option.POLL_OPTION_IMG}" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="11" alt="{poll_option.POLL_OPTION_PERCENT}" /></td>
					<td><img src="templates/Skaidon/images/vote_rcap.gif" width="6" alt="" height="11" /></td>
				  </tr>
				</table>
			  </td>
