...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline2" align="center">
	<tr>
	...
	<tr>
		<td colspan="7" height="1" class="spaceRow"><img src="../templates/Skaidon/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END catrow -->
	<tr>
