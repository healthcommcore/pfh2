		...
		<td><table width="100%" border="0" cellspacing="1" cellpadding="4" class="forumline">
			...
			<tr>
				<td><table width="100" border="0" cellspacing="0" cellpadding="5">
					...
					<tr align="center"> 
						<td colspan="{S_SMILIES_COLSPAN}"><span  class="nav2"><a href="{U_MORE_SMILIES}" onclick="open_window('{U_MORE_SMILIES}', 250, 300);return false" target="_smilies" class="nav2">{L_MORE_SMILIES}</a></td>
					</tr>
