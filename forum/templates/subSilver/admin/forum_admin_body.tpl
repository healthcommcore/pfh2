...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr>
		...
		<!-- mb sf1 -->
		<td class="cat" align="center" valign="middle"><span class="gen">&nbsp</span></td><td class="catRight" align="center" valign="middle"><span class="cattitle">{L_MAKE_STATIC}</span></td>
	</tr>
	<!-- BEGIN forumrow -->
	<tr> 
		...
		<!-- mb sf1 -->
		<td class="row1" align="center" valign="middle"><span class="gen">sf1 <input type="checkbox" {catrow.forumrow.CHECKED} name="static_id_{catrow.forumrow.FORUM_ID}"> up/down</span></td>
	</tr>
	<!-- END forumrow -->
	<tr>
	...
	<!-- mb sf1 -->
		<td class="row2" align="center"><input type="submit" class="liteoption"  name="static_toggle" value="{L_SUBMIT}" /></td>
	</tr>
	<tr>
