...
<table width="100%" cellspacing="0" cellpadding="2"  border="0">
	<tr>
		<td><a href="/forum/viewforum.php?f=1"><img src="/images/forum/forumTopics5.gif" width="122" height="24" border="0" alt="Back to Topic list" vspace="0"></a><br /><br /><br /></td>
		<td rowspan="4">
...
<!-- 				  <span  class="nav"><a href="{U_MORE_SMILIES}" onclick="window.open('{U_MORE_SMILIES}', '_phpbbsmilies', 'HEIGHT=300,resizable=yes,scrollbars=yes,WIDTH=250');return false;" target="_phpbbsmilies" class="nav">{L_MORE_SMILIES}</a></span>
 -->			
			...
			<span class="forumTextSMALL">Click on a face to include <br />it in your message.<br /><br />Each face will translate into text in the box on the left. After you click Submit, the face you chose will appear in your post.</span></td>
		  </tr>
		  </table>
		  </td>
	</tr>
	<tr><!--  New Topic: {L_SUBJECT}: -->
		<td><span class="gen"><b>Subject/Topic:</b></span> <br /><span class="gen"> 
		<input type="text" name="subject" size="35" maxlength="60" style="width:400px" tabindex="2" class="post" value="{SUBJECT}" />
		</span></td>
	</tr>
	<tr>
		<td><br /><span class="gen"><b>Your Message:</b><br />
			  <textarea name="message" rows="10" cols="30" wrap="virtual" style="width:400px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
			  </span></td>
	</tr>
	<tr>
		<td align="center" nowrap> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;&nbsp;<input type="button" tabindex="7" class="mainoption" value="Cancel" onClick="document.location='viewforum.php?f=1';" />&nbsp;</td>
	</tr>
<!-- 
	<tr>
 ...
 -->
	<tr>
		<td colspan="2" align="right" height="50" valign="bottom"><span class="nav"><i>Be sure to read up on our <a href="/policies2.php" class="navview">forum rules and regulations</a>.</i></span></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
