...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr> 
	<td align="left" valign="middle" nowrap="nowrap"><span class="nav"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" align="middle" /></a>&nbsp;&nbsp;&nbsp;<a href="{U_POST_REPLY_TOPIC}"><img src="{REPLY_IMG}" border="0" alt="{L_POST_REPLY_TOPIC}" align="middle" /></a>&nbsp;&nbsp;&nbsp;<a href="/forum/viewforum.php?f=1"><img src="/images/forum/forumTopics5.gif" width="122" height="24" border="0" alt="Back to Topic list" align="middle"></a></span></td>
...
-->
	...
	<tr> <!-- class="postdetails" -->
		<td  align="left" valign="top" class="{postrow.ROW_CLASS}"><span class="name">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.POSTER_AVATAR}<br /></span><br /></td>
		<td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="top"><span class="postbody">{postrow.MESSAGE}{postrow.SIGNATURE}</span><span class="gensmall">{postrow.EDITED_MESSAGE}</span></td>
	</tr>
<!--
...
-->
	<tr> 
		...
		<td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="top" nowrap="nowrap">
{postrow.EDIT_IMG} | {postrow.DELETE_IMG} | <a href="privmsg.php?mode=post&u=4" title="Send private message to Administrator or Moderator"><img src="templates/subSilver/images/lang_english/icon_pm.gif" alt="Send private message to Katie" title="Send private message" border="0" /></a></td>
	</tr><!-- {postrow.PM_IMG} -->
...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  ...
  <tr> 
	<td align="left" valign="bottom" nowrap="nowrap"><span class="nav"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" align="middle" /></a>&nbsp;&nbsp;&nbsp;<a href="{U_POST_REPLY_TOPIC}"><img src="{REPLY_IMG}" border="0" alt="{L_POST_REPLY_TOPIC}" align="middle" /></a>&nbsp;&nbsp;&nbsp;<a href="/forum/viewforum.php?f=1"><img src="/images/forum/forumTopics5.gif" width="122" height="24" border="0" alt="Back to Topic list" align="middle"></span></td>
