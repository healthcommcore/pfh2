...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  ...
  <tr> 
	<td align="left" valign="bottom" colspan="2">
	 <a class="maintitle" href="{U_VIEW_TOPIC}"></a><span class="maintitle">{TOPIC_TITLE}</span><br /> 
...
<table width="100%" cellspacing="0" cellpadding="0" class="thforumline">
	<tr>
		<th class="thLeft" width="139" align="left" nowrap="nowrap">{L_AUTHOR}</th>
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="135" nowrap="nowrap">{postrow.REPORT_IMG}</td>
	</tr>
</table></td>
	</tr>
</table></td>
