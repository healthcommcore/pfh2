...
$mysqlID=dbConnect();
$resultID=mysql_query("UPDATE PFHUserInfo SET smallStepsCHECKS=\"".$smallStepsCHECKS."\", smallStepsNOTES=\"".addslashes($smallStepsNOTES)."\" WHERE id=".$_SESSION["userID"],$mysqlID);
dbClose();
echo "<b>Thank you. Your changes have been saved.</b><br><br>\n\n";
}
?>

Even though you don't want to quit smoking now, maybe you'd like to try a few steps to see what it would be like to quit someday. Click on the boxes next to the suggestions you want to try. See how they feel &nbsp; &#150;  they might be easier than you thought.<br><br>
...
<PARAM NAME=movie VALUE="images/flash/list3.swf">
<PARAM NAME=quality VALUE=high>
<PARAM NAME=bgcolor VALUE=#FBFAE9>
<EMBED width=341 height=635 bgcolor="#FBFAE9" name="myList" src="images/flash/list3.swf" quality=high TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" swLiveConnect="true"></EMBED>
</OBJECT><br><br>
