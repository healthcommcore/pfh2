...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/tips_talkWithDoc.gif" width=400 height=99 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

As someone who had childhood cancer, it's important for you to have information about your health history and your current health. <br><br>
<img src="images/tipsheets/talk-with-doc.jpg" width=341 height=155 border=0 alt=""><br><br>

Because cancer can be a complicated disease, you may have questions that your primary care provider might not be able to answer. Some childhood cancer survivors like to include an oncologist as part of their team of doctors. This gives them the chance to ask health questions as they come up, and get clear answers.<br><br>

If you have two (or more) doctors who take care of you, you know that it can be a challenge to communicate with each one. You may even find yourself needing to tell one doctor the suggestions or comments of  the other. But the better you are able to talk with your doctors, the better care you will get. Below are some tips for talking with your doctor or doctors:

<ul>
<li><a href="health_tips-talkWithDoc1.php">Before Appointments</a></li>
<li><a href="health_tips-talkWithDoc2.php">During Appointments</a></li>
</ul><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><b>Talking With Your Doctor</b>
            <ul class="UL2">
            <li><a href="health_tips-talkWithDoc1.php" class="tipsSubLink">Before Appointments</a></li>
            <li><a href="health_tips-talkWithDoc2.php" class="tipsSubLink">During Appointments</a></li>
            </ul></li>
        </ul></div>
