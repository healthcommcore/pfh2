...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/tips_stress.gif" width=400 height=99 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

<img src="images/tipsheets/stress.jpg" width=180 height=335 border=0 alt="" align="left" style="padding-right:20px; padding-top:3px; padding-bottom:16px;">
Feeling stressed? You're not the only one. Stress is something that affects almost everyone. Learning how to cope with stress is important for many reasons. The obvious one is that if you can handle stress, you'll feel more relaxed. But you may not know that learning to manage stress can also help you deal better with life's challenges. <br><br>

A lot of smokers use cigarettes as a way to control their stress. But really, cigarettes only add problems, not fix them. By learning other ways to lower stress, you might be less likely to reach for a smoke when you're stressed out.<br><br>

The first step in de-stressing is recognizing the symptoms of stress.
<ul>
<li><a href="health_tips-stressB1.php">Emotional Signs and Thoughts</a></li>
<li><a href="health_tips-stressB2.php">Behavioral and Physical Signs</a></li>
</ul>

Here are some of the many ways to help control stress:
<ul>
<li><a href="health_tips-stressB3.php">Manage Your Lifestyle/Take Care of Yourself</a></li>
<li><a href="health_tips-stressB4.php">Use Relaxation Techniques</a></li>
<li><a href="health_tips-stressB5.php">Complementary or Alternative Medicine</a></li>
<li><a href="health_tips-stressB6.php">Talk to Someone</a></li>
</ul>
<b>Note: Some people experience stress, anxiety, or worry that they just can't put aside. If this sounds like you, it's important to talk about it with your health care provider.</b><br><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <div style="margin-left:12px; margin-top:0px; margin-right:12px; margin-bottom:5px;" class="tipsSubText">
        <ul class="UL1">
        <li><b>Getting a Handle on Stress</b>
            <ul class="UL2">
            <li><a href="health_tips-stressB1.php" class="tipsSubLink">Emotional Signs and Thoughts</a></li>
            <li><a href="health_tips-stressB2.php" class="tipsSubLink">Behavioral and Physical Signs</a></li>
            <li><a href="health_tips-stressB3.php" class="tipsSubLink">Manage Your Lifestyle/Take Care of Yourself</a></li>
            <li><a href="health_tips-stressB4.php" class="tipsSubLink">Use Relaxation Techniques</a></li>
            <li><a href="health_tips-stressB5.php" class="tipsSubLink">Complementary or Alternative Medicine</a></li>
            <li><a href="health_tips-stressB6.php" class="tipsSubLink">Talk to Someone</a></li>
            </ul></li>
