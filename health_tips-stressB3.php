...
<span class="tipsHeader">MANAGE YOUR LIFESTYLE / TAKE CARE OF YOURSELF</span><br><br>

<b>Manage Your Lifestyle</b>
<ul>
<li>Get enough <a href="health_tips-sleep.php">sleep</a>.</li>
<li>Make time to unwind and have fun.</li>
<li>Eat a balanced <a href="health_tips-weight.php">diet</a>.</li>
<li>Get regular <a href="health_tips-activity.php">exercise</a>.</li>
<li>Try not to overindulge in food or alcohol. </li>
<li>Avoid drugs.</li>
<li>Avoid smoking.</li>
<li>Limit the amount of caffeine you drink.</li>
<li>Learn how to manage your time, and say no when you need to.</li>
<li>Use a <a href="health_tips-socialSupport.php">support system</a> (friends, family, co-workers, social/spiritual organizations) and ask for help.</li>
</ul><br>

<b>Take Care of Yourself</b>
<ul>
<li>Get wellness checkups.</li>
<li>Stay on top of any chronic health problems.</li>
<li>Keep open lines of communication with your health care providers. Learn the best way to <a href="health_tips-talkWithDoc.php">talk with your doctor</a>.</li>
</ul>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <div style="margin-left:12px; margin-top:0px; margin-right:12px; margin-bottom:5px;" class="tipsSubText">
        <ul class="UL1">
        <li><a href="health_tips-stressB.php" class="tipsSubLink"><b>Getting a Handle on Stress</b></a>
            <ul class="UL2">
            ...
            <li><b>Manage Your Lifestyle/Take Care of Yourself</b></li>
