...
<span class="tipsHeader">CALORIES</span><br><br>

Calories provide a measure of how much energy you get from a serving of this food. Many Americans take in way more calories than they need without getting recommended intakes of a number of nutrients. The calorie section of the label can help you manage your weight, whether you want to gain, lose, or maintain your weight. Remember, the number of<a href="health_tips-nutrition_label1.php"> servings</a> you eat determines the number of calories you actually eat (your portion amount). So if a serving size is listed as one cup and it contains 75 calories, if you eat two cups, you are actually taking in 150 calories.<p>

<b>A General Guide to Calories</b>
...
The General Guide to Calories provides a general reference for calories when you look at a Nutrition Facts label. This guide is based on a 2,000 calorie diet.
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><a href="health_tips-nutrition_label.php" class="tipsSubLink"><b>Nutrition Label Lingo</b></a>
            ...
            <li><b>Calories</b></li>
            <li><a href="health_tips-nutrition_label3.php" class="tipsSubLink">The Nutrients: How Much?</a></li>
            </ul></li>
