...
<span class="tipsHeader">SERVING SIZE</span><br><br>

The first place to start when you look at the Nutrition Facts label is the serving size and the number of servings in the package. Serving sizes are standardized to make it easier to compare similar foods. They are provided in familiar units, such as cups or pieces, followed by the metric amount (the number of grams).<p>

The size of the serving on the food package is tied to the number of calories and all the nutrient amounts listed on the top part of the label. Pay attention to the serving size, especially how many servings there are in the food package. Then ask yourself, &#8220;How many servings am I eating?&#8221; For example, on some packages, one serving of macaroni and cheese equals one cup. If you ate the whole package, you would be eating two cups. That doubles the calories and other nutrient numbers, including the % Daily Values.
