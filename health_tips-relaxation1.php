...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/tips_relaxation.gif" width=400 height=99 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

<span class="tipsHeader">DEEP BREATHING AND VISUAL IMAGERY</span><br><br>

<b>Deep Breathing</b><br>
Slow, deep breathing from the abdomen (the area below your rib cage) goes a long way in helping you relax. That's because it increases the amount of oxygen in your body and lowers your heart rate.
<ul>
<li>Put one hand on your abdomen and practice breathing so your abdomen expands as you breathe in. </li>
<li>Imagine that the incoming breath is filling a balloon in your abdomen. </li>
<li>When you can't inhale any more, breathe out, and imagine the balloon emptying. </li>
</ul><br>

<b>Visual Imagery</b><br>
Picturing a pleasant scene can help control stress, because a positive mental image can drive away worry and other negative emotions.
<ul>
<li>Close your eyes and imagine a pleasant place you have been or someplace you would like to be. This image can include sights around you, as well as sounds or even smells.</li>
<li>Focus on your image while breathing slowly and deeply. Say to yourself, "You are feeling warm and relaxed," or "You feel peaceful, without a care in the world."</li>
</ul></ul>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><a href="health_tips-relaxation.php" class="tipsSubLink"><b>Relaxation Techniques</b></a>
            <ul class="UL2">
            <li><b>Deep Breathing and Visual Imagery</b></li>
            <li><a href="health_tips-relaxation2.php" class="tipsSubLink">Progressive Muscle Relaxation and Meditation</a></li>
            <li><a href="health_tips-relaxation3.php" class="tipsSubLink">Yoga, Massage, Music, and Writing</a></li>
            </ul></li>
