...
Many adults say they would like to lose some weight, and childhood cancer survivors are no different. They may have difficulty controlling their weight because of a disability or other late effects of their illness or its treatment. Certain medications (like steroids, for example) can also lead to weight gain.<br><br>
<img src="images/tipsheets/weight.jpg" width=340 height=140 border=0 alt=""><br><br>

Even though most smokers say they worry about gaining weight when they quit smoking, the truth is that not all smokers gain weight. Of those who do, most gain only between five and 10 pounds.<br><br>

If you do gain some weight when quitting smoking, remind yourself that it's a <b>normal</b> part of quitting. And remember that whether or not you gain weight depends on what you eat, how much you eat, and if you <a href="health_tips-activity.php">exercise</a>. So you <b>can</b> have some control here!<br><br>

Most importantly, remind yourself that temporary weight gain is much less dangerous than the risks of smoking. You would have to gain 80 to 100 pounds to offset the health benefits of quitting smoking!

<ul>
<li><a href="health_tips-weight1.php">Eating Healthy</a></li>
<li><a href="health_tips-weight2.php">Smart Snacks</a></li>
<li><a href="health_tips-weight3.php">Keep That Mouth Moving</a></li>
<li><a href="health_tips-weight4.php">&#133;or Skip the Snacks</a></li>
<li><a href="health_tips-weight5.php">Get Active</a></li>
</ul><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><b>Weight Issues</b>
            <ul class="UL2">
            <li><a href="health_tips-weight1.php" class="tipsSubLink">Eating Healthy</a></li>
