...
<img src="images/tipsheets/nutrition_label.jpg" width=172 height=168 border=0 alt="" align="right" style="padding-left:20px; padding-top:3px; padding-bottom:16px;">
Everyone knows what a Nutrition Facts label looks like. Knowing how to read one, however, is another story. Check out these explanations of serving size, calories, and nutrient information, so you can make healthier choices the next time you're <a href="health_tips-supermarket.php">shopping</a>.<br><br>

&nbsp;
<ul>
<li><a href="health_tips-nutrition_label1.php">Serving Size</a></li>
<li><a href="health_tips-nutrition_label2.php">Calories</a></li>
<li><a href="health_tips-nutrition_label3.php">The Nutrients: How Much?</a></li>
</ul><br>
