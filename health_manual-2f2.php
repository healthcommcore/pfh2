...
<form name="form1" method="GET" action="health_manual-2f2.php">
...
<? } else { ?>
    ...
    <? if ($HTTP_GET_VARS["showAnswer"]!="none") { ?>
        <? if ($HTTP_GET_VARS["showAnswer"]=="all") { ?>
            ...
            <ul>
            <? if (ereg("\|1\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=1">You're Worried About How to Deal with Stress, Anxiety, or Bad Moods</a></li><? } ?>
            <? if (ereg("\|2\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=2">You Just Like Smoking</a></li><? } ?>
            <? if (ereg("\|3\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=3">You're Worried About Weight Gain</a></li><? } ?>
            <? if (ereg("\|4\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=4">You Just Don't Know How to Quit</a></li><? } ?>
            <? if (ereg("\|5\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=5">You've Tried to Quit Before</a></li><? } ?>
            <? if (ereg("\|6\|",$HTTP_GET_VARS["showAnswer"])) { ?><li><a href="health_manual-2f2.php?showAnswer=6">You Spend Time Around Smokers/<br>Smokers You Know Don't Think Quitting Is Important</a></li><? } ?>
            </ul>
            <div align="right" style="padding-right:20px;"><a href="health_manual-2f2.php?showAnswer=retake">retake quiz</a></div>
        ...
        <? } else { ?>
            ...
            if ($HTTP_POST_VARS["submitAction"]=="saveEntry") {
                ...
                dbClose();
                echo "<br><span class=\"confirmMsg\">THANK YOU! Your changes have been saved. <a href=\"health_manual-2f2.php?showAnswer=all\">Click here</a> to return to your barriers list.</a></span><br><br>\n\n";
            } else {
                echo "<a href=\"health_manual-2f2.php?showAnswer=all\">&#171; back to barriers list</a><br><br>\n\n";
            }
            ?>
            ...
            <a href="health_manual-2f2.php?showAnswer=all">&#171; back to barriers list</a></div>
        <? } ?>
    ...
    <div align="right" style="padding-right:20px;"><a href="health_manual-2f2.php">retake quiz</a></div>
    <? } ?>
...
<? if (strlen($HTTP_GET_VARS["showAnswer"])==1) { ?>
    ...
    <PARAM NAME=movie VALUE="images/flash/list21f_<?=$HTTP_GET_VARS["showAnswer"]?>.swf">
    <PARAM NAME=quality VALUE=high>
    <PARAM NAME=bgcolor VALUE=#FBFAE9>
    <EMBED width=341 height=310 bgcolor="#FBFAE9" name="myList" src="images/flash/list21f_<?=$HTTP_GET_VARS["showAnswer"]?>.swf" quality=high TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" swLiveConnect="true"></EMBED>
    </OBJECT><br><br>
<? } ?>
