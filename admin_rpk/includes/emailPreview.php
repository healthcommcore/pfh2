...
if ($ep=popen("/usr/sbin/sendmail -t -i ","w")) {
    ...
    fputs($ep,"Content-Type: multipart/alternative; boundary=\"MultipartBoundaryAlternative\"\n\n");
        ...
        fputs($ep,"<tr bgcolor=\"#DCE2EE\">\n");
        fputs($ep,"    <td width=450 colspan=2 valign=\"top\"><img src=\"cid:logo.gif\" width=450 height=220 border=0></td>\n");
        fputs($ep,"    <td width=190 rowspan=2 valign=\"top\"><img src=\"cid:right.gif\" width=190 height=760 border=0></td>\n");
        fputs($ep,"</tr>\n");
        fputs($ep,"<tr bgcolor=\"#DCE2EE\">\n");
        fputs($ep,"    <td width=30 valign=\"top\" bgcolor=\"#DCE2EE\"><img src=\"cid:blank.gif\" width=30 height=540 border=0></td>\n");
        ...
        while (list($k,$v)=each($emailBody2)) {
            if (strlen(trim($v))>0) fputs($ep,$v."<br>\n");
        }
        fputs($ep,"<br><br>&nbsp;</td>\n");
        fputs($ep,"</tr>\n");
        fputs($ep,"</table>\n");
