...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/benefits_of_breakfast.gif" width=400 height=100 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

<span class="tipsHeader">BEST REASONS TO EAT BREAKFAST</span><br><br>


<li><b>Getting your fill of fruits and veggies.</b> People who eat breakfast get more fruits and vegetables than people who skip it. Eating more fruits and vegetables can help keep your weight down.</li><p>

<li><b>Controlling weight.</b> Skipping breakfast can make you get really hungry and eat too much at lunch and other meals. A Harvard research study found that men who skip breakfast are four times more likely to be obese than men who eat breakfast. And research shows that breakfast eaters are leaner in general than those who skip it.</li><p>

<li><b>Staying alert.</b> If you skip breakfast, your blood sugar level drops. This can make you feel tired, slowed down, and unable to concentrate. Eating breakfast can help you stay focused. Breakfast foods with protein are even better, because they help delay hunger for lunch.</li><p>

<li><b>Lowering your risk of disease.</b> High-fiber cereals are a big part of breakfast's health benefits. They can help you lower your risk of heart disease, stroke, diabetes, and high cholesterol.</li>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <div style="margin-left:12px; margin-top:0px; margin-right:12px; margin-bottom:5px;" class="tipsSubText">
        <ul class="UL1">
        <li><a href="health_tips-breakfast.php" class="tipsSubLink"><b>The Benefits of Breakfast</b></a>
            <ul class="UL2">
            <li><b>Best Reasons to Eat Breakfast</b></li>
            <li><a href="health_tips-breakfast2.php" class="tipsSubLink">Breakfast Foods to Choose</a></li>
            <li><a href="health_tips-breakfast3.php" class="tipsSubLink">Beat-the-Clock Breakfasts</a></li>
            </ul></li>
