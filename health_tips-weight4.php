...
<span class="tipsHeader">&#133;OR SKIP THE SNACKS</span><br><br>

Sometimes being bored can lead to snacking. But there are lots of ways to keep busy that don't involve food:
<ul>
<li>take a walk</li>
<li><a href="health_tips-socialSupport.php">call, email, or IM a friend</a></li>
<li>do a crossword puzzle</li>
<li>take a bath</li>
<li>garden</li>
<li>write, draw, or scrapbook</li>
<li>play with your kids or a pet</li>
<li><a href="health_tips-activity.php">exercise</a></li>
</ul>
...
tyWomens.php" class="tipsSubLink">5. Women's Fertility and Cancer Treatment</a><br><br>
        <b>6. Memory</b><br><br>
        <a href="health_tips-relaxation.php" class="tipsSubLink">7. Relaxation Techniques</a><br><br>
        <a href="health_tips-sleep.php" class="tipsSubLink">8. Sleep</a><br><br>
        <a href="health_tips-socialSupport.php" class="tipsSubLink">9. Help from Friends and Family</a><br><br>
        <a href="health_tips-stress.php" class="tipsSubLink">10. Getting a Handle on Stress</a><br><br>
        <a href="health_tips-talkWithDoc.php" class="tipsSubLink">11. Talking With Your Doctor</a><br><br>
        <a href="health_tips-weight.php" class="tipsSubLink">12. Weight Issues</a><br>
        </div><br>
        &nbsp;</td>
    </tr>
    </table><img src="images/white.gif" width=170 height=18 border=0 alt=""><br>
