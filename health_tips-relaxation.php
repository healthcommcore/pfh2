...
<tr>
<td valign="top" class="column2Text">When it comes to lowering <a href="health_tips-stress.php">stress</a> and dealing with <a href="health_tips-depression.php">depression</a>, there are several relaxation techniques that may help you. Choose one or two from the list below and try them out. It may take some practice before you are comfortable with them, but in time, you will feel the benefits. After you become more familiar with those exercises, you can try out some of the others.</td>
<td align="right" valign="top"><img src="images/tipsheets/relaxation.jpg" width=181 height=273 border=0 alt="" style="padding-left:20px; padding-top:3px; padding-bottom:16px;"></td>
</tr>
</table>

<ul>
<li><a href="health_tips-relaxation1.php">Deep Breathing and Visual Imagery</a></li>
<li><a href="health_tips-relaxation2.php">Progressive Muscle Relaxation and Meditation</a></li>
<li><a href="health_tips-relaxation3.php">Yoga, Massage, Music, and Writing</a></li>
</ul><br>
