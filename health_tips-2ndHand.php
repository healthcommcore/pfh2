...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/secondhand_smoke.gif" width=400 height=100 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

Everyone knows something about secondhand smoke, but many people don't know all the details about what makes it so dangerous.<p>

<img src="images/tipsheets/secondhand_smoke.jpg" width=172 height=193 border=0 alt="" align="right" style="padding-left:20px; padding-top:3px; padding-bottom:16px;">
Secondhand smoke (sometimes called environmental tobacco smoke, or ETS) is the combination of smoke from the end of a cigarette, pipe, or cigar, and the smoke exhaled by the smoker. Most nonsmokers find secondhand smoke annoying and irritating. But secondhand smoke does much more than smell up restaurants, cars, and homes: it also creates a health hazard.<p>

<a href="health_tips-2ndHand1.php">Dangers to Adults</a><br>
<a href="health_tips-2ndHand2.php">Dangers to Children and Babies</a><br>
<a href="health_tips-2ndHand3.php">What to Do About Secondhand Smoke</a><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><b>Secondhand Smoke</b>
            <ul class="UL2">
            <li><a href="health_tips-2ndHand1.php" class="tipsSubLink">Dangers to Adults</a></li>
            <li><a href="health_tips-2ndHand2.php" class="tipsSubLink">Dangers to Children and Babies</a></li>
            <li><a href="health_tips-2ndHand3.php" class="tipsSubLink">What to Do About Secondhand Smoke</a></li>
            </ul></li>
