...
<? include("includes/greenbar.php"); ?>
    ...
    <!-- COLUMN 2 -->
    <!-- ======== -->
    <td width=400 valign="top"><img src="images/pageTitles/tips_depression.gif" width=400 height=99 border=0 alt=""><br><br>
        <table border=0 cellpadding=0 cellspacing=0 width=400>
        <tr>
            <td width=25><img src="images/blank.gif" width=25 height=1 border=0 alt=""></td>
            <td width=345 valign="top" class="column2Text"><img src="images/blank.gif" width=345 height=1 border=0 alt=""><br>

<span class="tipsHeader">SYMPTOMS OF DEPRESSION</span><br><br>

Depression is different from person to person. But common signs of depression include:
<ul>
<li>sadness</li>
<li>loss of interest in or enjoyment of normal activities</li>
<li>sleeping more or less than usual</li>
<li>eating more or less than usual</li>
<li>decreased sexual desire</li>
<li>feeling restless and nervous</li>
<li>feeling slowed down</li><li>fatigue or loss of energy</li>
<li>feeling guilty or worthless</li>
<li>self-critical thoughts</li>
...
<li>thoughts about death or suicide</li>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <li><a href="health_tips-depression.php" class="tipsSubLink"><b>Depression</b></a>
            <ul class="UL2">
            <li><b>Symptoms of Depression</b></li>
            <li><a href="health_tips-depression2.php" class="tipsSubLink">Treating Depression</a></li>
            </ul></li>
