...
<span class="tipsHeader">PHYSICAL AND MENTAL PLUSES OF EXERCISE</span><br><br>

<b>Physical Pluses</b><br>
<ul>
<li>lowers health risks that can cause heart disease</li>
<li>helps prevent high blood pressure, obesity, and Type II diabetes</li>
<li>lowers risk of developing certain cancers, including colon, rectal, and breast cancers</li>
<li>increases strength and muscle mass</li>
<li>increases energy level</li>
<li>helps the heart work more efficiently </li>
<li>helps you burn calories more quickly</li>
<li>increases flexibility </li>
<li>helps you <a href="health_tips-sleep.php">sleep</a> better</li>
<li>protects against osteoporosis </li>
</ul><br>

<b>Mental Pluses</b><br>
<ul>
<li>lowers <a href="health_tips-stress.php">stress</a></li>
<li>reduces <a href="health_tips-stress.php">anxiety</a></li>
<li>reduces <a href="health_tips-depression.php">depression</a></li>
<li>increases confidence</li>
<li>improves mood</li><li>provides feeling of strength</li></ul><br>
    ...
    <tr bgcolor="#FBFAE9">
        ...
        <ul class="UL1">
        <li><a href="health_tips-activity.php" class="tipsSubLink"><b>Exercise</b></a>
            <ul class="UL2">
            <li><b>Physical and Mental Pluses of Exercise</b></li>
