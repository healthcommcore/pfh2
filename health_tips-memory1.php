...
<span class="tipsHeader">THE BASICS</span><br>
<ul>
<li>If you are having significant problems with memory, get a complete check-up. Your health care provider should order blood tests. If you have a history of thyroid disease, make sure the blood tests include one for thyroid function.</li>
<li>Reduce feelings of fatigue by getting enough sleep. Be sure to visit the <a href="health_tips-sleep.php">Sleep</a> tip sheet for more ideas.</li>
<li>Try some <a href="health_tips-relaxation.php">relaxation techniques </a> for lowering stress, which may help improve your memory.</li>
</ul><br>
